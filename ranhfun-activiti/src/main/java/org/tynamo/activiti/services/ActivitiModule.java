		...
		StandaloneProcessEngineConfiguration cfg = new StandaloneProcessEngineConfiguration() {
			...
			protected void initJpa() {
				...
				if (jpaEntityManagerFactory != null)
					sessionFactories.put(EntityManagerSession.class, new TapestryEntityManagerSessionFactory(entityManagerManager, jpaEntityManagerFactory, jpaHandleTransaction, jpaCloseEntityManager));
			}
		};
