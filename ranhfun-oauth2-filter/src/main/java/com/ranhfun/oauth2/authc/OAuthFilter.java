package com.ranhfun.oauth2.authc;
...
public class OAuthFilter extends AuthenticatingFilter {
    ...
    private String fallbackUrl;
  	...
  	public OAuthFilter(LoginContextService loginContextService) {
    ...
    protected AuthenticationToken createToken(ServletRequest request, ServletResponse response) throws Exception {
        ...
        OAuthToken oAuthToken = new OAuthToken(code);
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
		...
		if (httpServletRequest.getQueryString() != null) fallbackUrl += "?" + httpServletRequest.getQueryString();
