...
public class IOHelper {
    ...
    public static String getDefaultDataDirectory() {
        return getDefaultDirectoryPrefix() + "price-data";
    }

    public static String getDefaultStoreDirectory() {
        return getDefaultDirectoryPrefix() + "picstore";
    }
    ...
    public static String getDefaultDirectoryPrefix() {
        try {
            return System.getProperty("com.ranhfun.price.default.directory.prefix", "");
        } catch (Exception e) {
            return "";
        }
    }
