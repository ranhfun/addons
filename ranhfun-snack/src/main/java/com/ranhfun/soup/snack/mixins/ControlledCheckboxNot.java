...
import com.ranhfun.soup.snack.components.ControlCheckNotLink;
 ...
 *
 */
public class ControlledCheckboxNot {
	
	@Parameter(name = "controllernot", required = true, defaultPrefix = BindingConstants.COMPONENT)
	private ControlCheckNotLink controller;
