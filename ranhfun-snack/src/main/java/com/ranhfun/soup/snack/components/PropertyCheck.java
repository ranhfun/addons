...
public class PropertyCheck
{
     ...
     */
    static class SetupEnvironment implements ComponentAction<PropertyCheck>
    {

		private static final long serialVersionUID = -103112308931875278L;
        ...
        public void execute(PropertyCheck component)
        {
    ...
    static class CleanupEnvironment implements ComponentAction<PropertyCheck>
    {
    ...
    void setupEnvironment(final String propertyName)
    {
        ...
        PropertyEditContext context = new PropertyEditContext()
        {
            ...
            {
                return propertyCheckMap.get(propertyModel.getPropertyName());
            }
            ...
            {
                propertyCheckMap.put(propertyModel.getPropertyName(), value);
            }
    ...
    Block beginRender()
    {
        ...
        return beanBlockSource.getEditBlock("boolean");
    }
