 ...
 * the {@link BeanExportForm}, and utilizes a {@link PropertyEditor} for much of its functionality. This component places
 * a {@link BeanEditContext} into the environment.
 */
@SupportsInformalParameters
public class BeanExport
{
    public static class Prepare implements ComponentAction<BeanExport>
    {
		private static final long serialVersionUID = -2523612932706525557L;

		public void execute(BeanExport component)
        {
            component.doPrepare();
        }
        ...
        {
            return "BeanExport.Prepare";
        }
    }

    static class CleanupEnvironment implements ComponentAction<BeanExport>
    {
		private static final long serialVersionUID = 7872112801228142323L;
        ...
        public String toString()
        {
            return "BeanExport.CleanupEnvironment";
        }
    }

    private static final ComponentAction<BeanExport> CLEANUP_ENVIRONMENT = new CleanupEnvironment();
    ...
    void doPrepare()
    {
        ...
        if (propertyCheckMap == null) {
        	propertyCheckMap = new HashMap<String, Object>();
        }
        
        if (propertyAliasMap == null) {
			propertyAliasMap = new HashMap<String, Object>();
		}
