...
import com.ranhfun.soup.snack.components.ControlCheckOppLink;
 ...
 *
 */
public class ControlledCheckboxOpp {
	
	@Parameter(name = "controlleropp", required = true, defaultPrefix = BindingConstants.COMPONENT)
	private ControlCheckOppLink controller;
