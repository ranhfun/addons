...
package com.ranhfun.resource.transform;
 ...
 * @since 5.2.0
 */
public class ImportWebAssetWorker implements ComponentClassTransformWorker2
{
    ...
    public ImportWebAssetWorker(JavaScriptSupport javascriptSupport, SymbolSource symbolSource, AssetSource assetSource)
    {
