...
@Path("/update2")
@Api(value = "update2", description = "版本接口", position = 1, basePath = "http://localhost:8081/api")
public class Update2Resource {
	...
	@ApiOperation(httpMethod="GET", nickname="getVersion", value="获取版本信息", consumes="application/xml")
	...
	@Path("version2")
	@Produces(MediaType.APPLICATION_JSON + ";charset=UTF-8")
	@ApiOperation(httpMethod="GET", nickname="getVersion2", value="获取版本信息", consumes="application/json")
