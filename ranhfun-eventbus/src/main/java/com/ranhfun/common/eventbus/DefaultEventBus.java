...
public class DefaultEventBus {
   ...
   */
  public DefaultEventBus(String identifier) {
 ...
 * @throws EventBusException 
   */
  void dispatchQueuedEvents() throws EventBusException {
 ...
 * @throws EventBusException 
   */
  void dispatch(Object event, EventHandler wrapper) throws EventBusException {
    try {
