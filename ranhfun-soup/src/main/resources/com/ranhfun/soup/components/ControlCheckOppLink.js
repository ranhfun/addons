...
var CheckboxGroupOppLink = function(controlCheckboxLink, controlledCheckboxes, type){
	this.initialize(controlCheckboxLink, controlledCheckboxes, type);
};

//defining the rest of the class implementation
CheckboxGroupOppLink.prototype = {
   ...
   initialize: function(controlCheckboxLink, controlledCheckboxes, type) {	        
		...
		var that = this;
		this.controlCheckboxLink.bind("click", {that:that}, this.selectOpposeCheckboxes);
		
   },
   
   selectOpposeCheckboxes: function(e) {
