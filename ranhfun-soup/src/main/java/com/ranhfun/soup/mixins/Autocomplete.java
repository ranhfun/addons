 ...
 * @tapestrydoc
 */
@Import(library = { "Autocomplete.js" })
...
public class Autocomplete
{
    ...
    Object onAutocomplete()
    {
       ...
       // ContentType contentType = new ContentType("text/json");
        return new TextStreamResponse("text/json", generateResponseJSON(matchesHolder.get()).toString());
    }
