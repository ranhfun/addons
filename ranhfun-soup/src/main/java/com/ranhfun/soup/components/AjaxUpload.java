 ...
 * @author criedel
 */
@Events( { SoupEventConstants.AJAX_UPLOAD } )
...
public class AjaxUpload implements ClientElement {
    ...
    void addInitScripts() {
        ...
        final JSONObject parameter = new JSONObject()
                ...
                .put("showMessagesDialog", "uploadErrorMesages")
        ...
        //javaScriptSupport.addScript("basicDialog('#uploadErrorMesages')");
    ...
    Object onUpload() {
        ...
        this.resources.triggerEvent(SoupEventConstants.AJAX_UPLOAD, new Object[]{ uploaded }, callback);
